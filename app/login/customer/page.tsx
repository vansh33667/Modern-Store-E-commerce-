...
export default function CustomerLoginPage() {
  ...
  useEffect(() => {
    if (!authLoading && isAuthenticated) {
      ...
      router.push(redirectUrl || "/customer-panel")
    }
    ...
    setTimeout(() => {
      ...
      if (storedUser) {
        ...
        if (user.type !== "customer") {
          setError("This login is only for business customers. Please use User Login.")
          setIsLoading(false)
          return
        }
      } else {
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Sign in to your business customer account</p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-border">
            <p className="text-center text-xs text-muted-foreground mb-3">Demo credentials (Customer):</p>
